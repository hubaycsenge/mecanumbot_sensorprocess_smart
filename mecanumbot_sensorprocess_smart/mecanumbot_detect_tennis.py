...
class TennisBallNode(Node):
    def __init__(self):
        ...
        self.camera_fov = math.radians(
            62.2
        )  # Assume 60 degree horizontal FOV, adjust as needed

        self.bridge = CvBridge()
        self.weight_file = (
            "yolov8n.pt"  # Ensure this file is in the 'models' directory of the package
        )
    ...
    def _process_image_worker(self, msg: CompressedImage):
        ...
        try:
            ...
            results = self.yolo_model.predict(
                cv_image, imgsz=self.inference_imgsz, verbose=False
            )

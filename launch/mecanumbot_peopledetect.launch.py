...
they mean and, in particular, for what `camera_source` is choosing between.
The default, `direct`, has the detector open the webcam itself, with no ROS
image topic in between.
